...
$string['includequestiontext_help'] = 'Including the question text might be important if your quiz uses random questions.';
$string['includeresponsetext'] = 'Response text';
