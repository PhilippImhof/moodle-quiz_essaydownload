...
$string['errorinvalidchars'] = 'Invalid characters found in a filename template. Forbidden characters include backslashes (\), forward slashes (/), and others typically forbidden in filenames.';
...
$string['filenametemplate'] = 'File name format template';
$string['filenametemplatehelp'] = 'Template for the file name. Supports the following placeholders:\n %firstname%, %lastname%, %userid%, %idnumber%, %username%';
...
$string['nametemplate'] = 'Name format template';
$string['nametemplatehelp'] = 'Template for the  name format. Supports the following placeholders:\n %firstname%, %lastname%, %userid%, %idnumber%, %username%';
