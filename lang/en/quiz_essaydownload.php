...
$string['errorinvalidchars'] = 'Invalid characters found in the filename template. Filenames must not contain any of the following characters: \, /, |, ", \', *, ?, <, >.';
$string['errorinvalidtokens'] = 'At least one template contains invalid placeholders. Valid placeholders are: %firstname%, %lastname%, %userid%, %idnumber%, %username%.';
...
$string['filenametemplate_help'] = 'Template for the filename. Supports the following placeholders:<ul><li>%firstname%</li><li>%lastname%</li><li>%username% (the username used to log in)</li><li>%userid% (the numerical id of the user)</li><li>%idnumber% (an optional external identifier for the user, used by some institutions)</li></ul>';
...
$string['nametemplate_help'] = 'Template for the name format. Supports the following placeholders:<ul><li>%firstname%</li><li>%lastname%</li><li>%username% (the username used to log in)</li><li>%userid% (the numerical id of the user)</li><li>%idnumber% (an optional external identifier for the user, used by some institutions)</li></ul>';
