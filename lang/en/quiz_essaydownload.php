...
$string['errorinvalidtemplate'] = 'Invalid template. The template must contain at least one placeholder and no other placeholders than the following: %firstname%, %lastname%, %userid%, %idnumber%, %username%.';
...
$string['eventresponsesdownloaded'] = 'Essay responses downloaded';
$string['eventresponsesdownloadfailed'] = 'Download of essay responses failed';
...
$string['filenametemplate'] = 'Filename template';
$string['filenametemplate_help'] = 'Template for the filenames inside the archive. Supports the following placeholders:<ul><li>%firstname%</li><li>%lastname%</li><li>%username% (the username used to log in)</li><li>%userid% (the numerical id of the user)</li><li>%idnumber% (an optional external identifier for the user, used by some institutions)</li></ul>';
$string['filter_couldnotparse'] = '[The HTML code of the student\'s answer code could not be parsed.]';
$string['filter_styleurlremoved'] = '[url(...) removed from style attribute of <{$a}> tag]';
$string['filter_tagattributeremoved'] = '[{$a->attribute} attribute removed from <{$a->tag}> tag]';
$string['filter_tagremoved'] = '[<{$a}> tag removed]';
...
$string['nametemplate'] = 'Name template';
$string['nametemplate_help'] = 'Template for the name format used in the page headers. Supports the following placeholders:<ul><li>%firstname%</li><li>%lastname%</li><li>%username% (the username used to log in)</li><li>%userid% (the numerical id of the user)</li><li>%idnumber% (an optional external identifier for the user, used by some institutions)</li></ul>';
