...
$string['filenametemplate'] = 'File name template';
$string['filenametemplate_help'] = 'Template for the file name. Supports the following placeholders:\n %firstname%, %lastname%, %userid%, %idnumber%, %username%';
...
$string['nametemplate_help'] = 'Template for the name format. Supports the following placeholders:\n %firstname%, %lastname%, %userid%, %idnumber%, %username%';
